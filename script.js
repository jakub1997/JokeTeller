...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '3311c37e322b427cbe0f698055db928f',
        src: joke,
        hl: 'en-ca',
        v: 'Rose',
        r: 0,
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Dark?blacklistFlags=nsfw,racist';
    try {
        ...
        // Catch Errors Here
        console.log("whoops, you have an error:", error);
    }
}
